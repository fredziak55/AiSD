...
benchmark() {
    ...
    runpython=""
    runcpp=""
    runexample="python3 sortowania-gotowe.py"
    ...
    echo "$algorithm_name,$input_file, $size,$time" >> benchmark_results.csv
    echo "------------------------"
}
...
echo "Algorithm,File,InputSize,Time" > benchmark_results.csv
